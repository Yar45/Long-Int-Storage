...
bool testMultiplicationOperator() {
    bool result = true;
...
int main() {
    ...
    result &= testStringConstructor();
    result &= testAbsStringConstructor();
    result &= testAdditionOperator();
    result &= testSubtractionOperator();
    result &= testMultiplicationOperator();
    result &= testComparisonOperators();
    result &= testAssignmentOperator();
    result &= testAbsOperator();
